...
Tribunal TRT2: Certidão Eletrônica de Ações Trabalhistas (CEAT) - Processos Digitais usa um único endpoint público (`https://api.mcp.ai/p_tribunal_trt2_ceat_digital`).
